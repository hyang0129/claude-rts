...
DEFAULT_CONFIG = {
    ...
    "credentials": {
        "probe_interval": 1800,       # seconds between full probe cycles
        "health_check_interval": 900, # seconds between health checks
        "max_data_age": 300,          # beyond this, data is too stale to display
    },
}
